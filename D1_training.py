...
def train_balloon_detector(
    model_name: str = "yolo11ll.pt",
    epochs: int = 200,
    batch: int = 16,
    imgsz: int = 640,
    device: int = 5,
    patience: int = 10,
    project_name: str = "D1_exp"
):
    """训练气球检测器"""
    ...
    # 配置文件路径
    config_file = Path("/public/home/baichen/download/dcu_yolo/ultralytics/my_D1.yaml").expanduser()
...
def predict_sample(project_name: str = "balloon_exp"):
    ...
    # 在验证集的一张图像上进行预测
    val_images_dir = "/public/home/baichen/download/dcu_yolo/ultralytics/data/D1_type3/yolo_format/images/val"
...
def main():
    ...
    # 训练参数
    parser.add_argument("--model", type=str, default="yolo11nll.pt", help="模型名称或路径")
    parser.add_argument("--epochs", type=int, default=200, help="训练轮数")
    parser.add_argument("--batch", type=int, default=16, help="批次大小")
    parser.add_argument("--imgsz", type=int, default=640, help="图片尺寸大小")
