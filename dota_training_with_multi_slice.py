...
class DotaTrainingPipeline:
    ...
    def __init__(
        ...
        project_name: str = "dota_yolo11l_multi_slice"
    ):
        """
        初始化训练流水线
    ...
    def train_model(
        ...
        # 使用预定义的数据集配置文件
        dataset_yaml = "dota_multi_slice.yaml"
...
def main():
    ...
    parser.add_argument("--project-name", type=str, default="dota_yolo11l_multi_slice", help="训练项目名称")
