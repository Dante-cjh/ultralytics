...
class BalloonTrainingPipeline:
    ...
    def __init__(
        ...
        project_name: str = "balloon_yolo11n_slice"
    ):
        """
        初始化训练流水线
...
def main():
    ...
    parser.add_argument("--slice-dir", type=str, 
                       default="/home/cjh/mmdetection/data/balloon/yolo_format_slice",
                       help="切片后数据保存目录")
    parser.add_argument("--project-name", type=str, default="balloon_yolo11n_slice", help="训练项目名称")
