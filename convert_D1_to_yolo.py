...
def convert_balloon_dataset():
    ...
    # 数据集路径
    balloon_root = Path("/public/home/baichen/download/dcu_yolo/ultralytics/data/D1_type3")
...
def verify_conversion():
    ...
    output_root = Path("/public/home/baichen/download/dcu_yolo/ultralytics/data/D1_type3/yolo_format")
