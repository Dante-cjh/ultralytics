...
def export_onnx(
    ...
    """Export a PyTorch model to ONNX format (alias for torch2onnx)."""
    return torch2onnx(torch_model, im, onnx_file, opset, input_names, output_names, dynamic)
...
def export_engine(
    ...
    """Export model to TensorRT format (alias for onnx2engine)."""
    return onnx2engine(onnx_file, engine_file, workspace, half, int8, dynamic, shape, dla, dataset, metadata, verbose, prefix)
